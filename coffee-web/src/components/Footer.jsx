      ...
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        ...
        <div>
          ...
          <nav className=" flex flex-col gap-2">
            <a className="hover:text-white transition-all cursor-pointer" href="/">
              Menu
            </a>
            <a className="hover:text-white transition-all cursor-pointer" href="/">
              About Us
            ...
            <a className="hover:text-white transition-all cursor-pointer hidden lg:inline-block" href="#contact">
              Contact Us
            </a>
          </nav>
        </div>
        <div>
          ...
          <nav className=" flex flex-col gap-2">
            ...
            <a className="hover:text-gray-500 transition-all cursor-pointer" href="/">
              Latte
            </a>
            <a className="hover:text-white transition-all cursor-pointer" href="/">
              Americano
