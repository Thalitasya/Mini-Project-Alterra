      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-gray-200 px-10 py-10 rounded-lg">
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-gray-400 px-3 py-1.5 text-sm font-semibold leading-6 text-black shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Login
            </button>
          </div>
