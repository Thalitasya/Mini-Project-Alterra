      ...
      <div>
        <div className="flex justify-between p-5 lg:px-32 px-5 bg-gradient-to-r from-purple-100 to-purple-300 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          ...
          <nav className="hidden md:flex items-center text-lg font-medium gap-8">
            <Link
              ...
              smooth={true}
              duration={500}
              className="group relative inline-block cursor-pointer hover:text-gray-500 text-base"
            >
              Home
            </Link>
            ...
            <Link
              ...
              smooth={true}
              duration={500}
              className="group relative inline-block cursor-pointer hover:text-gray-700 text-base"
            >
              Menu
            </Link>
        ...
        >
          <Link
            ...
            smooth={true}
            duration={500}
            className="hover:text-pink-500 transition-all cursor-pointer text-base"
            onClick={closeMenu}
          >
            Home
          </Link>
